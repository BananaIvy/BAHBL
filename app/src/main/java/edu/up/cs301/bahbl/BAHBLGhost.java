...
BAHBLGhost extends BAHBLCustomerBase {
    ...
    public BAHBLGhost() {
        ...
        setGreetingDialogue("Hey, I'm glad you showed up. I wasn't too sure you would. The last guy quit suddenly and, well, let's just say you didn't look the most trustworthy yourself." +
        ...
        setLoreDialogue("Now, I'll try and keep this simple and quick. When a customer comes up, you'll greet them politely and tap on the register to collect their money and send them away." +
        ...
        setFarewellDialogue("All right, get to work, and remember, if you die, that waiver you signed means I can't be held accountable.");
