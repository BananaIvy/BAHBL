...
BAHBLGhost extends BAHBLCustomerBase {
    ...
    public BAHBLGhost() {
        ...
        setGreetingDialogue("Welcome to BAHBL!");
                //"Hey, I'm glad you showed up. I wasn't too sure you would. The last guy quit suddenly and, well, let's just say you didn't look the most trustworthy yourself." +
